...
public class Ex14Test extends Ex14
{
    public static void main(String args[])
    {
        ...
        if (search(arr2x2, 1))
            ...
            System.out.println("Error - your search: " + search(arr2x2, 1) + "Expect: true");
        ...
        int [][] arr16x16 = {{1,2,5,6,17,18,21,22,65,66,69,70,81,82,85,86},
                               ...
                               {237,238,241,242,225,226,229,230,177,178,181,182,161,162,165,166},
                               {240,239,244,243,228,227,232,231,180,179,184,183,164,163,168,167},
                               {249,250,245,246,255,256,233,234,189,190,185,186,173,174,169,170},
                               {252,251,248,247,258,257,236,235,192,191,188,187,176,175,172,171}};
        ...
        if (!search(arr16x16, 253))
            System.out.println("OK");
        else
            System.out.println("Error - your search: " + search(arr16x16, 253) + "Expect: false");
        ...
        if (isSpecial(1))
            ...
            System.out.println("Error - your isSpecial: " + isSpecial(1) + "Expect: true");
        
        System.out.print("Test #2 - 2:......");
        if (!isSpecial(2))
            System.out.println("OK");
        else
            System.out.println("Error - your isSpecial: " + isSpecial(2) + "Expect: false");
        
        System.out.print("Test #3 - 3:......");
        if (isSpecial(3))
            System.out.println("OK");
        else
            System.out.println("Error - your isSpecial: " + isSpecial(3) + "Expect: true");
            
        System.out.print("Test #4 - 5:......");
        if (!isSpecial(5))
            System.out.println("OK");
        else
            System.out.println("Error - your isSpecial: " + isSpecial(5) + "Expect: false");
        ...
        if (!isSpecial(10))
            ...
            System.out.println("Error - your isSpecial: " + isSpecial(10) + "Expect: false");
        
        System.out.print("Test #7 - 13:......");
        if (isSpecial(13))
            System.out.println("OK");
        else
            System.out.println("Error - your isSpecial: " + isSpecial(13) + "Expect: true");
            
        System.out.print("Test #8 - 17:......");
        if (!isSpecial(17))
            System.out.println("OK");
        else
            System.out.println("Error - your isSpecial: " + isSpecial(17) + "Expect: false");
            
        System.out.print("Test #9 - 21:......");
        if (!isSpecial(21))
            System.out.println("OK");
        else
            System.out.println("Error - your isSpecial: " + isSpecial(21) + "Expect: false");
            
        System.out.print("Test #10 - 25:......");
        if (isSpecial(27))
            System.out.println("OK");
        else
            System.out.println("Error - your isSpecial: " + isSpecial(27) + "Expect: false");
    }//End of Main
}//End of Test